disease_dic = {
    ...
    '(maize)___Common_rust_': """ <b>Crop</b>: maize <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:

        <br/><br/>Common rust caused by P. sorghi, an obligate pathogen of maize and a
macrocyclic heteroecious fungus, occurs in all areas of the world where maize is grown.
The fungus thrives in high humidity and moderate temperature conditions  Two sources from Kenya were identified as Kitale flat white and Njoro
flat white (Hooker 1962).

        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1.AMISTAR TOP® 325SC Fungicide for the control of Grey Leaf Spot, Leaf Blight and Common Rust in Maize. Rust, Angular leafspot and Anthracnose in French beans. Ascochyta leafspot and powdery mildew on snow peas and Powdery Mildew in Roses
